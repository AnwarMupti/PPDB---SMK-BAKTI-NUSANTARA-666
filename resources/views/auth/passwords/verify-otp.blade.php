...
<head>
    ...
    <title>Verifikasi OTP Reset Password - PPDB SMK Bakti Nusantara 666</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .email-badge {
            ...
            margin: 16px 0; text-align: center; border: 2px solid #e2e8f0;
        }
        .email-badge i { color: #0ea5e9; margin-right: 6px; font-size: 14px; }
        .email-badge strong { color: #1e293b; font-size: 13px; }
        
        .otp-inputs { display: flex; gap: 7px; justify-content: center; margin: 20px 0; }
        .otp-input {
            width: 46px; height: 54px; text-align: center; font-size: 20px; font-weight: 700;
            border: 2px solid #e5e7eb; border-radius: 8px; transition: all 0.2s ease;
            font-family: 'Poppins', sans-serif; color: #1e293b;
        }
        .otp-input:focus {
            outline: none; border-color: #0ea5e9;
            box-shadow: 0 0 0 3px rgba(14, 165, 233, 0.1); transform: scale(1.05);
        }
        
        .btn-verify {
            width: 100%; background: linear-gradient(135deg, #0ea5e9 0%, #3b82f6 100%);
            color: white; border: none; padding: 12px; border-radius: 8px;
            font-size: 13px; font-weight: 700; cursor: pointer; transition: all 0.2s ease; margin-top: 16px;
        }
        .btn-verify:hover { transform: translateY(-2px); box-shadow: 0 8px 25px rgba(14, 165, 233, 0.4); }
        .btn-verify:disabled { opacity: 0.6; cursor: not-allowed; }
        
        .resend-section {
            text-align: center; margin-top: 16px; padding-top: 16px;
            border-top: 1px solid #e5e7eb; font-size: 12px; color: #64748b;
        }
        .resend-section a {
            color: #0ea5e9; text-decoration: none; font-weight: 600; transition: all 0.2s;
        }
        .resend-section a:hover { color: #0284c7; text-decoration: underline; }
        
        .timer {
            display: inline-block; background: #fef3c7; color: #92400e;
            padding: 4px 12px; border-radius: 20px; font-size: 12px; font-weight: 600; margin-left: 8px;
        }
        ...
        @media (max-width: 576px) {
            .otp-card { padding: 20px 18px; }
            .otp-inputs { gap: 5px; }
            .otp-input { width: 42px; height: 50px; font-size: 18px; }
            .card-header h2 { font-size: 18px; }
            .otp-icon { width: 55px; height: 55px; font-size: 26px; }
        }
    </style>
</head>
<body>
    <div class="auth-container">
        <div class="left-layer">
            ...
            <div class="left-content">
                ...
                <p>Kami telah mengirimkan kode OTP 6 digit ke email Anda. Masukkan kode tersebut untuk melanjutkan proses reset password.</p>
        ...
        <div class="right-layer">
            <div class="otp-card">
                ...
                <div class="resend-section">
                    Tidak menerima kode? 
                    <a href="{{ route('password.resend.otp') }}" id="resendLink">
