...
<head>
    ...
    <title>Lupa Password - PPDB SMK Bakti Nusantara 666</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .back-section a:hover { color: #0284c7; text-decoration: underline; }
        ...
        @media (max-width: 576px) {
            .forgot-card { padding: 20px 18px; }
            .card-header h2 { font-size: 18px; }
            .forgot-icon { width: 55px; height: 55px; font-size: 26px; }
        }
    </style>
</head>
<body>
    <div class="auth-container">
        <div class="left-layer">
            ...
            <div class="left-content">
                <h2>Lupa Password?</h2>
                <p>Jangan khawatir! Masukkan email Anda dan kami akan mengirimkan kode OTP untuk mereset password Anda.</p>
                ...
                <ul class="security-features">
                    ...
                    <li class="security-item">
                        ...
                        <span>Proses reset aman dan terenkripsi</span>
                    </li>
                    <li class="security-item">
