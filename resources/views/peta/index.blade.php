...
<script>
    // Initialize map (centered on SMK Bakti Nusantara 666)
    var map = L.map('map').setView([-6.9397, 107.7536], 12); // SMK Bakti Nusantara 666 coordinates
    ...
    // School location (SMK Bakti Nusantara 666 - Cileunyi, Bandung)
    ...
    schoolMarker.bindPopup('<div style="min-width: 200px;"><strong style="font-size: 15px;">SMK Bakti Nusantara 666</strong><br><small>Jl. Raya Percobaan No.65, Cileunyi Kulon<br>Kec. Cileunyi, Kabupaten Bandung, Jawa Barat 40622</small><br><em style="color: #ef4444;">📍 Lokasi Sekolah</em></div>');
