            ...
            <div class="card shadow-sm h-100">
                ...
                <div class="card-body p-2">
                    <table class="table table-sm table-borderless mb-0" style="font-size: 12px;">
                        ...
                        <tr><td class="text-muted py-1">Kecamatan</td><td class="fw-semibold py-1">{{ $dataSiswa->kecamatan ?? '-' }}</td></tr>
                        <tr><td class="text-muted py-1">Kabupaten</td><td class="fw-semibold py-1">{{ $dataSiswa->kabupaten ?? '-' }}</td></tr>
                        <tr><td class="text-muted py-1">Provinsi</td><td class="fw-semibold py-1">{{ $dataSiswa->provinsi ?? '-' }}</td></tr>
                        @if($dataSiswa->lat && $dataSiswa->lng)
                        <tr><td class="text-muted py-1">Koordinat</td><td class="fw-semibold py-1"><a href="https://www.google.com/maps?q={{ $dataSiswa->lat }},{{ $dataSiswa->lng }}" target="_blank" class="text-primary"><i class="bi bi-geo-alt-fill"></i> Lihat Maps</a></td></tr>
                        @endif
            ...
            <div class="card shadow-sm h-100">
                ...
                <div class="card-body p-2">
                    ...
                    <table class="table table-sm table-borderless mb-0" style="font-size: 12px;">
                        ...
                        <tr><td class="text-muted py-1">Alamat Sekolah</td><td class="fw-semibold py-1">{{ $dataSekolah->kabupaten ?? '-' }}</td></tr>
